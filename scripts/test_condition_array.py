...
async def main():
    ...
    # 获取报告
    report_empty = app.report(task_id_empty)
    print(f"Task ID: {task_id_empty}")
    print(f"Workflow status: {report_empty.workflow_status.status}")
    print(f"Inputs: {report_empty.inputs}")
    print(f"Outputs: {report_empty.outputs}")
    
    # 测试非空数组
    print_section("Testing with non-empty array")
    task_id_not_empty = app.run({
        "schema": schema,
    ...
    # 获取报告
    report_not_empty = app.report(task_id_not_empty)
    print(f"Task ID: {task_id_not_empty}")
    print(f"Workflow status: {report_not_empty.workflow_status.status}")
    print(f"Inputs: {report_not_empty.inputs}")
    print(f"Outputs: {report_not_empty.outputs}")
    ...
    # 获取报告
    report_complex_empty = app.report(task_id_complex_empty)
    print(f"Task ID: {task_id_complex_empty}")
    print(f"Workflow status: {report_complex_empty.workflow_status.status}")
    print(f"Inputs: {report_complex_empty.inputs}")
    print(f"Outputs: {report_complex_empty.outputs}")
    ...
    task_id_complex_not_empty = app.run({
        "schema": complex_schema,
        "inputs": {
            "themes": ["露营", "登山", "滑雪", "徒步"],
            "apiKey": "test-key",
    ...
    # 获取报告
    report_complex_not_empty = app.report(task_id_complex_not_empty)
    print(f"Task ID: {task_id_complex_not_empty}")
    print(f"Workflow status: {report_complex_not_empty.workflow_status.status}")
    print(f"Inputs: {report_complex_not_empty.inputs}")
    print(f"Outputs: {report_complex_not_empty.outputs}")
